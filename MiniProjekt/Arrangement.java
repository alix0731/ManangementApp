...
public class Arrangement{
   ...
   public void createEvent(){
      ...
      //Create Costumer |
      newCostumer.createCostumer();
      //Indsæt infp i filen
      writeFile(newCostumer.getInfo());
      ...
      do{
         ...
         try{
            ...
            //Create Event | input sker i konstruktøren
               event = new Event();
            
            //Tilføj events til ArrayList
               events.add(event);
            
               
               writeFile(event.getInfo());
         ...
         System.out.print("Do you want to make a new event?: [Y/N]: ");
   ...
   ///////FILER/////
    ...
    //Så vi kan add/slette events i andre klasser
